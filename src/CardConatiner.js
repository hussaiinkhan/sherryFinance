...
function CardContainer() {
  return (
    <>
      <h2 className="text-5xl font-bold text-center text-white py-4  mt-12 rounded-lg shadow-lg bg-gradient-to-r from-[#172e1b] to-[#042541]">Purchase Your Plan</h2>
      <div className='w-full pb-[10rem] px-4 mt-12'>
